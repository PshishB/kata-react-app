       ...
       return (
        <ul className="filters">
            <li>
                ...
                onClick={() => this.handleFilterClick('all')} > All</button>
            </li>
            <li>
              <button className={this.state.selectedFilter === 'active' ? 'selected' : ''} 
              onClick={() => this.handleFilterClick('active')}>Active</button>
            </li>
            <li>
              <button  className={this.state.selectedFilter === 'completed' ? 'selected' : ''} 
              onClick={() => this.handleFilterClick('completed')}>Completed</button>
            </li>
        </ul>
    )
  }
